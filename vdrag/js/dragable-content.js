	...
	************************************************************************************************************/	
	...
	if(!window.rememberPosition_cookieName)var rememberPosition_cookieName = 'dragable';
	...
	*/	
	...
	function moveDragableElement(e)
	{
        ...
        dragObjCloneArray[numericIdToBeDragged].style.filter = 'alpha(opacity=70)';
		dragObjCloneArray[numericIdToBeDragged].style.opacity = '0.7';
	}
	
	function stop_dragDropElement()
	{
		dragDropTimer = -1;
		 dragObjCloneArray[numericIdToBeDragged].style.filter = 'alpha(opacity=100)';
		 dragObjCloneArray[numericIdToBeDragged].style.opacity = '1.0';
	...
	function createCookieString()
	{
		...
		Set_Cookie(rememberPosition_cookieName,stringToSave,60000);
	}
	...
	{
        var cookieValue = Get_Cookie(rememberPosition_cookieName);
        Set_Cookie(rememberPosition_cookieName,'',-500);	
		alert('Actualiser la page pour voir le changement');
